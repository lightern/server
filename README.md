...
Create tables:
```
CREATE TABLE companies (companyid SERIAL PRIMARY KEY, name VARCHAR NOT NULL, idea VARCHAR NOT NULL, code VARCHAR NOT NULL, sector VARCHAR NOT NULL, subcode VARCHAR NOT NULL, subsector VARCHAR NOT NULL, city VARCHAR NOT NULL, area VARCHAR NOT NULL);
